...
export default (variables = variable) => {
    ...
    const buttonTheme = {
        ...
        '.actionModal': {
            ...
            justifyContent: 'center',
            height: 'auto',
            elevation: variables.isAndroid ? 0 : 2,
            'NativeBase.Text': {
                textAlign: 'center',
                lineHeight: variables.btnModalLineHieght
            },
        },
        '.actionModalHalf': {
            backgroundColor: 'transparent',
        ...
        '.phoneButton': {
            elevation: variables.isAndroid ? 1 : 2
        },
        'NativeBase.Text': {
        ...
        '.choice': {
            ...
            'NativeBase.Text': {
                ...
                flex: 1,
                paddingLeft: variables.inputPaddingHorizontal,
                lineHeight: variables.inputHeightBase,
            },
            'NativeBase.Icon': {
                padding: 0,
                color: variables.inputColorPlaceholder,
        ...
        ".notification": {
            backgroundColor: variable.transparent
        },
