...
class CheckTimeLocationListScreen extends React.PureComponent {
    ...
    render() {
        ...
        const checkInLatestPlace = data.filter((item) => {
            if (typeName === 'daily') {
                return !!find(this.props.checkInTimeToday, (o) => o.place ? o.place.id === item.id : false);
            } else {
                return !!find(this.props.checkInTimeOutsideToday, (o) => o.place ? o.place.id === item.id : false);
            }
        });
