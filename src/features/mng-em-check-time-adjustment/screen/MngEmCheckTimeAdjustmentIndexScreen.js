...
MngCheckTimeAdjustmentIndexScreen.navigationOptions = {
    headerTitle: <HeaderTitle text={'mng.check_time_adjustment.history.title'} />,
};
...
export default connect(
    ...
    null
)(MngCheckTimeAdjustmentIndexScreen);
