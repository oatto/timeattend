...
const initialState = {
    ...makeInitialState(FETCH_MNG_EM_CHECK_TIME_ADJUSTMENT_REQUESTED_STATE_KEY),
    ...makeInitialState(FETCH_MNG_EM_CHECK_TIME_ADJUSTMENT_APPROVED_STATE_KEY),
    ...makeInitialState(FETCH_MNG_EM_CHECK_TIME_ADJUSTMENT_REJECTED_STATE_KEY)
};
