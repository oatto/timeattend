...
export function getLocationWithTokenAndDeviceLatLong(payload) {
    return EmployeeClient.get(`/check-in-place/token/${payload.token}/${payload.deviceLatitude}/${payload.deviceLongitude}`);
}
