...
export const NAME = 'pushMessageForm';

class PushMessageForm extends React.PureComponent {
    render() {
        return (
            <Form>
                <View padder>
                ...
                <View style={[s.flx_row]}>
                    ...
                    >
                        <CommonText
                            bold
                            text={Trans.tran('mng.employee_management.modal.form.send')}
                        />
                    </Button>
                </View>
            </Form>
